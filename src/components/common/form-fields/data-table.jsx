...
//!DOM da tanımlı eventler onCLick onChange alabilir
//!Row componenti DOM da olmayan bir element
//!o yüzden onClick i row un propu olarak alıp componentte karşılayacağız
export const Row = ({ children, selectionMode, onClick, selected }) => {
