"use client";
import { createAssistantManagerActions } from "@/actions/assistant-manager-actions";
...
const AssistantManagerCreateForm = () => {
  const [state, dispatch] = useFormState(createAssistantManagerActions, initialResponse);
...
export default AssistantManagerCreateForm;
